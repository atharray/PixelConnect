...
const PixelatorModal: React.FC<PixelatorModalProps> = ({ isOpen, onClose, layer }) => {
  ...
  }, [layer.imageData, targetHeight, ditherMethod, ditherStrength, getPalette, resamplingMethod, useKmeans, kmeansColors, brightness, contrast, saturation]);
  ...
  const handleSuggestColors = useCallback(() => {
    ...
    img.src = layer.imageData;
  }, [layer.imageData, getPalette, suggestCount]);
